"""
Django settings for bacteriophage_organizations project.
...
ROOT_URLCONF = 'bacteriophage_organizations.urls'
...
WSGI_APPLICATION = 'bacteriophage_organizations.wsgi.application'
