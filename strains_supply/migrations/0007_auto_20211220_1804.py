# Generated by Django 3.2.10 on 2021-12-20 15:04
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('strains_supply', '0006_alter_companybranch_alias'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='supply',
            name='updated_by',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='strains_supply_supply_related', to='auth.user', verbose_name='Обновил'),
            preserve_default=False,
        ),
    ]
